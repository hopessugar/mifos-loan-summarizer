 ...
 * 
 * Note: Cannot use useTranslation hook here because this is rendered
 * outside the normal component tree (via ErrorBoundary class component).
 * We import translations directly instead.
 */
        ...
        {isDevelopment && error && (
          <details className="mt-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
            ...
            <div className="mt-4 space-y-4">
              {/* Error Message */}
              <div>
                <h3 className="text-sm font-semibold text-gray-700 mb-2">{t('error.message')}</h3>
              ...
              {error.stack && (
                <div>
                  <h3 className="text-sm font-semibold text-gray-700 mb-2">{t('error.stack')}</h3>
              ...
              {errorInfo?.componentStack && (
                <div>
                  <h3 className="text-sm font-semibold text-gray-700 mb-2">{t('error.componentStack')}</h3>
                  <pre className="text-xs text-gray-600 bg-gray-100 p-3 rounded overflow-auto max-h-64">
                    {errorInfo.componentStack}
                  </pre>
                </div>
